...
`ploopyco_madromys_rev1_001_ergo_test_rclick.uf2` maps **all eight buttons to right click**.
...
firmware uses USB PID `0x5C49` so it never collides with the real one.
